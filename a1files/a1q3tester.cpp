...
int main(void){
    ...
    if(numPassed == numTests){
        std::cout << "Congratulations! You have passed testing for A1 part 3" << std::endl << std::endl;
        ...
        std::cout << "   * go to: https://seneca-btp500f19.github.io/btp500-f19/test3.html" << std::endl;
